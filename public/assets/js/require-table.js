define(['jquery', 'bootstrap', 'moment', 'moment/locale/en-gb', 'bootstrap-table', 'bootstrap-table-lang', 'bootstrap-table-export', 'bootstrap-table-commonsearch', 'bootstrap-table-template', 'bootstrap-table-jumpto', 'bootstrap-table-fixed-columns'], function ($, undefined, Moment) {
    var Table = {
        list: {},
            ...
            bindevent: function (table) {
                ...
                table.on('check.bs.table uncheck.bs.table check-all.bs.table uncheck-all.bs.table post-body.bs.table', function (e) {
                    ...
                    if (exportDataType === 'auto') {
                        ...
                        $(".export .exporttips").html("Export Records：" + (selectedIds.length > 0 ? "Selected" : "All"));
