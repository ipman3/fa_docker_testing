define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'mydir/test/index' + location.search,
                    add_url: 'mydir/test/add',
                    edit_url: 'mydir/test/edit',
                    del_url: 'mydir/test/del',
                    multi_url: 'mydir/test/multi',
                    import_url: 'mydir/test/import',
                    table: 'test',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'mydir/test/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
